  ...
  return (
    <div className="bg-slate-50 font-sans min-h-screen flex flex-col items-center justify-center">
      <div className="relative w-full max-w-md h-full min-h-screen flex flex-col bg-white shadow-xl overflow-hidden">
        ...
        <div className="flex-1 px-8 pt-8 flex flex-col gap-5">
          ...
          <div className="relative">
            ...
            <input 
              ...
              placeholder="请输入密码" 
            />
            <button type="button" className="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-slate-600">
              <Eye />
            </button>
          </div>

          <div className="flex justify-end">
            <button className="text-sm font-medium text-slate-500 hover:text-pink-600 transition-colors">
              忘记密码？
            </button>
          </div>

          <button onClick={() => navigate('/')} className="w-full py-4 px-4 bg-pink-600 hover:bg-pink-700 text-white font-bold rounded-full shadow-lg shadow-pink-600/30 transition-all transform active:scale-[0.98] mt-2">
            登录
          </button>
          ...
          <div className="flex items-start gap-2 mt-2">
            ...
            <label htmlFor="terms" className="text-xs text-slate-500">
              我已阅读并同意 <button className="text-pink-600 hover:underline">《服务条款》</button> 和 <button className="text-pink-600 hover:underline">《隐私政策》</button>。
            </label>
          </div>
        </div>
